...
class SetupFilamentPermissionsCommand extends Command
{
    protected $signature = 'filament:setup {model?} {--all : Setup for all models} {--custom= : Add custom actions (comma separated)}';
